...
| [`okpack-competitive`](packs/okpack-competitive) | competitive / market intelligence for ANY tracked market — competitors, products, segments, deals, signals (method-only; identity supplied at deploy) | flagship-generic |
...
| [`okpack-vendor-risk`](packs/okpack-vendor-risk) | vendor / supply-chain risk — vendors, products, components, contracts, incidents; risk ranking against an operator dependency profile (okengine#174) | community |
| [`okpack-cti`](packs/okpack-cti) | security / threat-intel (STIX-aligned) — a composed bundle of the CTI packs | bundle |
| [`okpack-threat-actors`](packs/okpack-threat-actors) | Threat-actor / adversary tracking from open-source threat intelligence (ATT&CK, MISP, CERT/vendor reporting) | community |
| [`okpack-vuln`](packs/okpack-vuln) | Actively-exploited vulnerability (CVE) tracking from CISA KEV | community |
| [`okpack-threat-landscape`](packs/okpack-threat-landscape) | Threat-landscape intelligence from annual security reports | community |
| [`okpack-indicators`](packs/okpack-indicators) | Atomic indicators (IOCs) + adversary infrastructure — abuse.ch URLhaus seed | community |
| [`okpack-detections`](packs/okpack-detections) | Detections (Sigma) + ATT&CK mitigations — SigmaHQ seed, ATT&CK-technique coverage | community |
| [`okpack-incidents`](packs/okpack-incidents) | Security incidents + the identities involved — VERIS Community Database seed | community |
