...
[![validate pack](https://github.com/REPLACE_OWNER/okpack-vendor-risk/actions/workflows/validate.yml/badge.svg)](https://github.com/REPLACE_OWNER/okpack-vendor-risk/actions/workflows/validate.yml)

Agent-curated Vendor / supply-chain risk for the OKEngine framework — ingests open feeds into a compounding, cross-linked knowledge graph.
...
## What this pack is (okengine#174)
...
okpack-competitive and okpack-sec own them; standalone vaults accept those pages
