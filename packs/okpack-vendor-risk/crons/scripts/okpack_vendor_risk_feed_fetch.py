#!/usr/bin/env python3
"""okpack-vendor-risk feed pull — fetch the vendor-risk OPML into raw/vendor-risk/ for the ingest lane.
...
Env: WIKI_PATH (default /opt/vault), OKPACK_VENDOR_RISK_FEEDS (default the deployed
...
raise SystemExit(feed_fetch.main([
    "--opml", os.environ.get("OKPACK_VENDOR_RISK_FEEDS", "/opt/data/config/feeds.opml"),
    "--out-dir", f"{WIKI}/raw/vendor-risk",
    "--state", "/opt/data/scripts/okpack-vendor-risk-feed-state.json",
    "--source-tag", "vendor-risk",
]))
