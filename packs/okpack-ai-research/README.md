...
This pack is already domain-filled. It is pinned to OKEngine `engine-v0.2.0`
with Hermes `v2026.6.5`; see `engine.version`.
...
- Docker Compose.
- An OKEngine checkout compatible with `engine-v0.2.0`.
...
(pinned engine-v0.2.0); the pack-specific orientation is here.
