...
raise SystemExit(feed_fetch.main([
    ...
    "--source-tag", "ai",
    # okengine#272: capture linked article/abstract full text (content-addressed, append-only)
    # under raw/captures/ — feed summaries alone are lossy secondary evidence.
    "--capture-full-text",
]))
