...
[![validate pack](https://github.com/REPLACE_OWNER/okpack-indicators/actions/workflows/validate.yml/badge.svg)](https://github.com/REPLACE_OWNER/okpack-indicators/actions/workflows/validate.yml)

Agent-curated Indicators & Infrastructure (IOCs) for the OKEngine framework — ingests open feeds into a compounding, cross-linked knowledge graph.

Pinned to engine **okengine v0.10.4** (see `engine.version`).
...
engine.version           engine pin (okengine v0.10.4)
