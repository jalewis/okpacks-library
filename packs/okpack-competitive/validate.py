#!/usr/bin/env python3
"""Validate the okpack-competitive domain pack — parse + cross-consistency checks.
...
def probe_feeds(urls: list[str]) -> None:
    ...
    for u in urls:
        if not u.lower().startswith("https://"):
            ...
            continue
        try:
            req = urllib.request.Request(u, method="GET", headers={"User-Agent": "okpack-competitive-validate"})
