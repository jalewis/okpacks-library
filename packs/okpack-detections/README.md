...
[![validate pack](https://github.com/REPLACE_OWNER/okpack-detections/actions/workflows/validate.yml/badge.svg)](https://github.com/REPLACE_OWNER/okpack-detections/actions/workflows/validate.yml)

Agent-curated Detections & Mitigations for the OKEngine framework — ingests open feeds into a compounding, cross-linked knowledge graph.
