...
- rec-12 (okpacks#60): `detection_format`/`rule_level` enums now compose, so bundle vaults enforce them.
...
### Added
- Detections (Sigma) + ATT&CK mitigations — SigmaHQ seed, technique coverage.
