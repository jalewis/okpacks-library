...
[![validate pack](https://github.com/REPLACE_OWNER/okpack-vuln/actions/workflows/validate.yml/badge.svg)](https://github.com/REPLACE_OWNER/okpack-vuln/actions/workflows/validate.yml)

Agent-curated Vulnerability / Exploited-CVE Tracking for the OKEngine framework — ingests open feeds into a compounding, cross-linked knowledge graph.
