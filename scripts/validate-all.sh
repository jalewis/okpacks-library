...
# _pack_validate_lib.py; fail if any copy drifted from the canonical (okpacks-library#17).
echo "==> validator-lib sync"
python3 "$ROOT/scripts/sync-validate-lib.py" --check || fail=1
shopt -s nullglob
