...
REQUIRED = {
    ...
    # A `kind: bundle` (okengine#181) owns nothing and ships no schema/feeds/conformance — it's a
    # RECIPE. Its readiness is the identity + recipe surface only (its members carry the content).
    "bundle":    ["readme", "pack_yaml", "validator", "license", "engine_pin"],
}
